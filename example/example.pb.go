...
var fileDescriptor_15a1dc8d40dadaa6 = []byte{
	...
	0x74, 0x98, 0x22, 0x18, 0xd7, 0xc8, 0x91, 0x8b, 0x15, 0xac, 0x4e, 0xc8, 0x82, 0x8b, 0x23, 0x38,
	0xb1, 0x12, 0xc2, 0x16, 0xd5, 0x83, 0xd9, 0x8c, 0x6c, 0x8f, 0x94, 0x30, 0xba, 0x70, 0x41, 0x4e,
	0xa5, 0x12, 0x43, 0x12, 0x1b, 0xd8, 0x79, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x38, 0xe7,
	0xf3, 0x54, 0xaf, 0x00, 0x00, 0x00,
}
...
func (c *helloClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/example.Hello/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
